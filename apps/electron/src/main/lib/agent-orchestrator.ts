...
import type { AgentRuntime, AgentSendInput, AgentMessage, AgentGenerateTitleInput, RegenerateTitleResult, AgentProviderAdapter, AgentSessionMeta, CodexOAuthCredentials, XaiOAuthCredentials, TypedError, RetryAttempt, SDKMessage, SDKAssistantMessage, AgentStreamPayload, RewindSessionResult, ProviderType } from '@proma/shared'
import {
...
export class AgentOrchestrator {
  ...
  private async autoGenerateTitle(
    ...
    try {
      ...
      // CAS：生成期间 maybeRefreshTitle 可能已完成并写入标题
